...
# Install dbt
RUN pip3 --disable-pip-version-check --no-cache-dir install duckdb==0.5.0 dbt-duckdb==1.1.4 \
    && rm -rf /tmp/pip-tmp

# Install duckdb cli
RUN wget https://github.com/duckdb/duckdb/releases/download/v0.5.0/duckdb_cli-linux-amd64.zip \
